...
gyeongnam = {
    '창원시': {
        'subs': ['진해석동', '자은동', '석동', '사파동', '상남동', '상남'],
        'feature': '경상남도 창원시는 상남동과 사파동을 중심으로 경남 최대 학원가가 형성된 지역입니다. 경상남도청 소재지이자 현대위아·두산에너빌리티 등 중공업 대기업 임직원 가정이 밀집해 학원 수준에 대한 눈높이가 경남 내 최상위입니다. 성산구 상남·사파 학원가와 진해구 석동 학원가가 각각 지역 수요를 소화하며, 수능·내신·특목고 전문 학원들이 경쟁하며 경남 최고 수준을 유지하고 있습니다.',
        'faq': [
            ('창원 상남동 학원가의 특징은 무엇인가요?', '상남동은 창원 성산구 최대 상업·주거지로 경남 최대 학원 밀집 지역입니다. 창원고·경남고·용호고 등 주요 고교 내신 기출 자료가 방대하게 축적되어 있으며, 중공업 임직원 가정의 높은 수요로 학원 커리큘럼 수준이 경남 내 최상위를 유지합니다.'),
            ('진해구 석동 학원가는 어떤 특징이 있나요?', '석동은 진해구 핵심 주거지로 진해 지역 중고교 내신 기출 자료를 보유한 학원들이 안정적으로 운영됩니다. 자은동을 포함한 진해 신도시 지역은 소수정예 관리형 학원 수요가 높으며, 학부모 커뮤니티를 통한 정보 공유가 활발합니다.'),
            ('창원에서 특목고 입시 준비가 가능한가요?', '상남동과 사파동에 경남과학고·경남외고 등 특목고 전문 입시 학원들이 운영됩니다. 중1부터 수학 심화와 영어 고급 과정을 시작하고 중2 때 자기소개서와 면접 대비를 추가하는 것이 일반적인 준비 일정입니다.'),
        ],
        'extra': [
            {'h2': '상남·사파 학원가 분석', 'content': '상남동 상업지구와 사파동 아파트 단지에 경남 최대 학원가가 형성되어 있습니다. 개원 10년 이상 검증된 학원들이 창원 지역 주요 고교 내신 기출을 방대하게 보유하고 있으며, 현대위아·두산 임직원 가정의 높은 교육 수요가 학원 수준을 끌어올리고 있습니다. 수능 전 과목 단과 조합이 자유롭고 특목고 전문 학원들도 집중되어 있습니다.', 'tip': '상남동 인기 학원은 방학 전 조기 마감이 잦으니 2개월 전에 문의하세요.'},
            {'h2': '중공업 도시 교육 환경', 'content': '현대위아·두산에너빌리티 등 중공업 임직원 가정은 이공계 직군 특성상 수학·과학 심화 교육에 높은 관심을 보입니다. 수능 수학과 물리·화학 전담 강사를 보유한 학원을 우선 선택하고, 경남과기대·경상국립대 이공계 진학을 목표로 하는 학생들을 위한 전문 학원들이 창원에 집중되어 있습니다. 대기업 임직원 가정 특성상 자녀 교육에 투자를 아끼지 않으며, 이것이 창원 학원 수준 향상의 핵심 동력입니다.', 'tip': None},
            {'h2': '수능·내신 병행 전략', 'content': '창원 학원들은 고1·2 내신과 수능 병행 관리 커리큘럼이 잘 갖춰져 있습니다. 고1은 내신 70%, 수능 기초 30% 비율로 균형을 잡고, 고2 2학기부터 수능 비중을 50%로 높이는 것이 표준입니다. 고3 초반에 수능 전 과목 체계를 완성하고, 내신 시험 2주 전만 집중 내신 모드로 전환하는 전략이 창원 상위권 학생들의 일반적인 방식입니다.', 'tip': None},
        ],
    },
}
...
count = 0
for si, data in gyeongnam.items():
